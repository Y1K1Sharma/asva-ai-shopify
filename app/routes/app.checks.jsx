...
export default function ChecksPage() {
  ...
  if (!unlocked) {
    return (
      <Page
        title="All Checks"
        subtitle="Every audit check that ran against your storefront."
      >
        <Banner title="Full check list not available" tone="info">
          ...
          <p>
            ...
            available on the Home page in the meantime.
          </p>
        </Banner>
      </Page>
    );
  ...
  return (
    <Page
      title="All Checks"
      subtitle={`Every audit check that ran (${allChecks.length} total).`}
    >
      <BlockStack gap="400">
        {cacheHit && (

...
export default function CrossProtocolPage() {
  const { scan, cacheHit, loadError } = useLoaderData();

  if (loadError) {
    return (
      <Page title="Cross-Protocol">
  ...
  if (!unlocked || !cp) {
    return (
      <Page
        ...
        subtitle="How UCP and ACP signals align across your storefront."
      >
        <Banner title="Cross-protocol data not available" tone="info">
          <p>
            ...
            this page will show your interop score, gap matrix between
  ...
  return (
    <Page
      title="Cross-Protocol"
      subtitle={cp.summary || "How UCP and ACP signals align across your storefront."}
    >
      <BlockStack gap="400">
        {cacheHit && (

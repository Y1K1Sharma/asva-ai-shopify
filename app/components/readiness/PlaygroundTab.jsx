    ...
    return (
      <Banner title="Manifest data not available" tone="info">
        <p>
          ...
          manifest from the audit. This tab will then show every
    ...
    return (
      <Banner title="No manifest detected" tone="warning">
        <p>
          ...
          store serves a manifest, this tab will display every section
          the audit parsed.
        </p>
        <p>
          See the <strong>Fixes</strong> tab for &ldquo;Set up
  ...
  return (
    <BlockStack gap="400">
      <Text as="p" variant="bodySm" tone="subdued">
        Every section of your parsed UCP manifest.
      </Text>
      {cacheHit && (
        <Text as="p" variant="bodySm" tone="subdued">

...
export function CatalogTab() {
  // catalog is fetched conditionally by the parent loader when ?tab=catalog;
  // see app._index.jsx. When the tab is freshly mounted before the loader
  // resolves, it will briefly be null.
  ...
  if (!catalog) {
    return (
      <BlockStack gap="400" inlineAlign="center">
        ...
        <Text as="p" tone="subdued">Loading your product catalog…</Text>
      </BlockStack>
    );
  }

  const { products, pageInfo, totalCount, precision, loadError } = catalog;
